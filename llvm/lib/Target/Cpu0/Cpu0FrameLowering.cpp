...
// Reture true if the specified function should have a dedicated frame pointer register. 
// This is true if the function has variable sized allocas,
// if it needs dynamic stack realignment, if frame pointer elimination is disabled, or if the frame address is taken.
