...
Cpu0SEFrameLowering::Cpu0SEFrameLowering(
    const Cpu0Subtarget &STI
) : Cpu0FrameLowering(STI, STI.getStackAlignment()) {}

void Cpu0SEFrameLowering::emitPrologue(
...
void Cpu0SEFrameLowering::emitEpilogue(
...
const Cpu0FrameLowering *llvm::createCpu0SEFrameLowering(
